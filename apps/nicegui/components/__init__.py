...
METRIC_GLOSSARY: dict[str, str] = {
    ...
    "Total P&L": "Sum of realized and unrealized profit/loss.",
    "Open Positions": "Currently active positions in the paper session.",
    "Fills": "Number of order fills (executions) in the session.",
    "Breakout Candidates": "Symbols meeting breakout criteria (gap >= 2% with filter thresholds).",
    "Breakdown Candidates": "Symbols meeting breakdown criteria (gap <= -2% with filter thresholds).",
    "2LYNCH Pass Rate": "Percentage of universe passing all 2LYNCH filter conditions (N, 2, Y, C, L).",
    "5D Breadth Ratio": "Ratio of 5-day advancers to decliners. Above 1 = bullish breadth.",
    "MA40 Breadth": "Percentage of universe trading above 40-day moving average. Above 70% = overbought.",
    "MA20 Breadth": "Percentage of universe trading above 20-day moving average.",
    "Aggression Score": "Composite score indicating market momentum strength (0-100).",
    "Universe Size": "Number of tradeable symbols in the backtest or scan universe.",
    "Capital": "Allocated capital per trade in rupees.",
    "Avg Holding": "Average number of days a position is held.",
    "Symbols Tracked": "Number of unique symbols that generated trades.",
    "Profitable Symbols": "Symbols with net positive total P/L.",
    "Symbol Win Rate": "Percentage of winning trades across all symbols.",
    "Best Symbol": "Symbol with the highest total P/L.",
}
...
NAV_ITEMS: list[dict[str, str | None]] = [
    ...
    {"label": "Symbols", "icon": "leaderboard", "path": "/symbols", "group": "Analysis"},
...
document.addEventListener('keydown', (e) => {
    if (e.altKey && !e.ctrlKey && !e.shiftKey) {
        const shortcuts = {
            ...
            'u': () => window.location.href = '/symbols',
